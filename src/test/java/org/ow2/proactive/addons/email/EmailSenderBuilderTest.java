...
public class EmailSenderBuilderTest {
    ...
    public void testDefaultValues() {
        ...
        assertThat(builder.getFileToAttache()).isNull();
        assertThat(builder.getFileName()).isEqualTo("Job_Logs");
    }
    ...
    public void testConstructor() {
        ...
        config.put(EmailSender.ARG_FILETOATTACHE, "file_path");
        ...
        assertThat(builder.getFileToAttache()).isEqualTo("file_path");
